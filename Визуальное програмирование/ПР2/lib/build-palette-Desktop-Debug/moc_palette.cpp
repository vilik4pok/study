...
QT_MOC_LITERAL(1, 8, 20), // "selectedColorChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5), // "color"
QT_MOC_LITERAL(4, 36, 3), // "row"
QT_MOC_LITERAL(5, 40, 6), // "column"
QT_MOC_LITERAL(6, 47, 13) // "buttonClicked"

    },
    "Palette\0selectedColorChanged\0\0color\0"
    "row\0column\0buttonClicked"
};
...
void Palette::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectedColorChanged((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (Palette::*_t)(QString , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Palette::selectedColorChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Palette::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Palette.data,
      qt_meta_data_Palette,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Palette::selectedColorChanged(QString _t1, int _t2, int _t3)
{
